package com.campus.repository.implementation;
...
public class LikeRepositoryImpl implements LikeRepository {
    ...
    public boolean saveLikeOrRemoveIfExists(Like like) {
        ...
        if (Like.LikeType.STUDENT_TO_STUDENT.equals(like.getType())) {
            return likeStudent(parameters);
        }
        if (Like.LikeType.STUDENT_TO_MESSAGE.equals(like.getType())) {
    ...
    private String likeTypeToSourceTable(Like.LikeType likeType) {
        if (Like.LikeType.STUDENT_TO_STUDENT.equals(likeType)) {
            return "STUDENT_LIKES";
        }
        if (Like.LikeType.STUDENT_TO_MESSAGE.equals(likeType)) {
